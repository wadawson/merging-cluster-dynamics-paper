...
Similarly, the gas pressure differential across cold front features seen in some merging clusters has also been used to estimate the Mach number of the cluster merger \citep[e.g.][]{Vikhlinin:2003wy}. 
...
As an aside it should be noted that for this comparison I use the \citet{Springel:2007bg} NFW halo parameters that represent the state of the halos prior to merger.
...
Thus the comparative results of Figure \ref{fig_SFcomparison} are conservative with respect to the variability of the halo properties throughout the merger.

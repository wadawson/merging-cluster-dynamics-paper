...
m1_lim = (10,20)
m2_lim = (1,2)
z1_lim = (0.2948,0.2964)
z2_lim = (0.2978,0.2987)
dproj_lim = (0.6,0.85)
alpha_lim = (0,90)
d3d_lim = (0,7)
dmax_lim =(0,7)
...
#axarr[1,0].set_ylabel('$M_{2} (10^{14} M_\odot)$')
#axarr[2,0].set_ylabel('$z_1$')
#axarr[3,0].set_ylabel('$z_2$')
#axarr[4,0].set_ylabel('$d_{proj}(t_{obs})$')
## Create the x-axes labels
#axarr[4,0].set_xlabel('$M_{1} (10^{14} M_\odot)$')
#axarr[4,1].set_xlabel('$M_{2} (10^{14} M_\odot)$')
#axarr[4,2].set_xlabel('$z_1$')
#axarr[4,3].set_xlabel('$z_2$')
#axarr[4,4].set_xlabel('$d_{proj}(t_{obs})$ (Mpc)')
...
#axarr[1,0].set_ylabel('$d_{3D}(t_{obs})$ (Mpc)')
#axarr[2,0].set_ylabel('$d_{max}$ (Mpc)')
## Create the x-axes labels
#axarr[2,0].set_xlabel('$M_{1} (10^{14} M_\odot)$')
#axarr[2,1].set_xlabel('$M_{2} (10^{14} M_\odot)$')
#axarr[2,2].set_xlabel('$z_1$')
#axarr[2,3].set_xlabel('$z_2$')
#axarr[2,4].set_xlabel('$d_{proj}(t_{obs})$ (Mpc)')
...
## Create the y-axes labels
#axarr[0,0].set_ylabel('$v_{3D}(t_{obs})$ (km s$^{-1}$)')
#axarr[1,0].set_ylabel('$v_{3D}(t_{col})$ (km s$^{-1}$)')
#axarr[2,0].set_ylabel('TSC$_0$ (Gyr)')
#axarr[3,0].set_ylabel('TSC$_1$ (Gyr)')
#axarr[4,0].set_ylabel('T (Gyr)')
## Create the x-axes labels
#axarr[4,0].set_xlabel('$M_{1} (10^{14} M_\odot)$')
#axarr[4,1].set_xlabel('$M_{2} (10^{14} M_\odot)$')
#axarr[4,2].set_xlabel('$z_1$')
#axarr[4,3].set_xlabel('$z_2$')
#axarr[4,4].set_xlabel('$d_{proj}(t_{obs})$')
...
#axarr[2,0].set_ylabel('$d_{max}$ (Mpc)')
## Create the x-axes labels
#axarr[2,0].set_xlabel(r'$\alpha$ (degrees)')
#axarr[2,1].set_xlabel('$d_{3D}(t_{obs})$ (Mpc)')
#axarr[2,2].set_xlabel('$d_{max}$ (Mpc)')
...
#axarr[4,0].set_ylabel('T (Gyr)')
## Create the x-axes labels
#axarr[4,0].set_xlabel(r'$\alpha$ (degrees)')
#axarr[4,1].set_xlabel('$d_{3D}(t_{obs})$ (Mpc)')
#axarr[4,2].set_xlabel('$d_{max}$ (Mpc)')
...
#axarr[4,0].set_ylabel('T (Gyr)')
## Create the x-axes labels
#axarr[4,0].set_xlabel('$v_{3D}(t_{obs})$ (km s$^{-1}$)')
#axarr[4,1].set_xlabel('$v_{3D}(t_{col})$ (km s$^{-1}$)')
#axarr[4,2].set_xlabel('TSC$_0$ (Gyr)')
#axarr[4,3].set_xlabel('TSC$_1$ (Gyr)')
#axarr[4,4].set_xlabel('T (Gyr)')

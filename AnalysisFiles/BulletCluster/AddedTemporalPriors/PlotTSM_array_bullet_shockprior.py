...
prefix_output = 'bullet_shockprior'
#Histogram bins
N_bins_2d = 100
N_bins_1d = 400
N_bins_TSM = 45
...
def histplot1d_part(ax,x,prob=None,N_bins=100,histrange=None,x_lim=None,y_lim=None):
    ...
    # Create location and confidence interval line plots
    ax.plot((loc,loc),(0,y_loc),'--k',linewidth=2,label='$C_{BI}$')
...
m1_lim = (10,20)
m2_lim = (1,2)
z1_lim = (0.2948,0.2968)
z2_lim = (0.2978,0.2988)
dproj_lim = (0.6,0.85)
alpha_lim = (0,90)
d3d_lim = (0.5,1.5)
dmax_lim =(0,4)
v3dcol_lim = (2000,4500)
v3dobs_lim = (500,4000)
tsc0_lim = (0,0.8)
tsc1_lim = (0,6)
t_lim = (0,6)
...
filename = prefix_output+'_input-input.pdf'
pylab.savefig(filename)
...
filename = prefix_output+'_input-geometry.pdf'
pylab.savefig(filename)
...
filename = prefix_output+'_input-vt.pdf'
pylab.savefig(filename)
...
filename = prefix_output+'_geometry-geometry.pdf'
pylab.savefig(filename)
...
filename = prefix_output+'_geometry-vt.pdf'
pylab.savefig(filename)
...
# First Column
histplot1d_part(axarr[0,0],v_3d_obs,prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=v3dobs_lim,y_lim=(0,500))
...
# Second Column
histplot1d_part(axarr[1,1],v_3d_col,prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=v3dcol_lim,y_lim=(0,1000))
...
# Fifth Column
histplot1d_part(axarr[4,4],T,prob=probinput,N_bins=N_bins_1d,histrange=histrange_T,x_lim=t_lim,y_lim=(0,2500))

filename = prefix_output+'_vt-vt.pdf'
pylab.savefig(filename)
...
histplot2d_part(ax,v_3d_col,TSM_0,prob=probinput,N_bins=N_bins_2d,histrange=(2000,4500,0,1),x_lim=(2000,4500),y_lim=(0,0.7))
#ax.scatter(v_3d_col[mask_combo],TSM_0[mask_combo],s=40,c='#57E964',marker='d',label="Within Input {0}$\sigma$".format(N_sigma))
#ax.scatter(v_3d_col[mask_alpha],TSM_0[mask_alpha],s=40,c=m_1[mask_alpha],marker='o',linewidths=0.5,label="Within Input {0}$\sigma$".format(N_sigma_alpha),cmap='Purples')
#ax.scatter(v_3d_col[mask_combo],TSM_0[mask_combo],s=40,c=alpha[mask_combo],marker='^',linewidths=0.5,label="Within Input {0}$\sigma$".format(N_sigma),cmap='Greens')
v_bullet_sf07 = 3400
t_bullet_sf07 = 0.18
...
#fig = pylab.figure()
#ax = fig.add_subplot(111)
#histplot2d_part(ax,v_3d_col,alpha,prob=probinput,N_bins=N_bins_2d,histrange=(2500,4500,0,90),x_lim=(2500,4500),y_lim=(0,90))
##ax.scatter(v_3d_col[mask_combo],TSM_0[mask_combo],s=40,c='#57E964',marker='d',label="Within Input {0}$\sigma$".format(N_sigma))
##ax.scatter(v_3d_col[mask_alpha],alpha[mask_alpha],s=40,c=m_1[mask_alpha],marker='o',linewidths=0.5,label="Within Input {0}$\sigma$".format(N_sigma_alpha),cmap='Purples')
##ax.scatter(v_3d_col[mask_combo],alpha[mask_combo],s=40,c=alpha[mask_combo],marker='^',linewidths=0.5,label="Within Input {0}$\sigma$".format(N_sigma),cmap='Greens')
##ax.legend(loc=0)
#pylab.xlabel('$v_{3D}(t_{col})$ (km s$^{-1}$)')
#pylab.ylabel(r'$\alpha$ (degrees)')
#pylab.savefig('Alphapeakvalues.pdf')

### Create the 1D histograms
#m1_loc, m1_ll_68, m1_ul_68, m1_ll_95, m1_ul_95 = histplot1d(m_1,'m1',prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=None,y_lim=None,x_label='m1',y_label=ylab,legend=None)

#m2_loc, m2_ll_68, m2_ul_68, m2_ll_95, m2_ul_95 = histplot1d(m_2,'m2',prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=None,y_lim=None,x_label='m2',y_label=ylab,legend=None)

#z1_loc, z1_ll_68, z1_ul_68, z1_ll_95, z1_ul_95 = histplot1d(z_1,'z1',prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=None,y_lim=None,x_label='z1',y_label=ylab,legend=None)

#z2_loc, z2_ll_68, z2_ul_68, z2_ll_95, z2_ul_95 = histplot1d(z_2,'z2',prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=None,y_lim=None,x_label='z2',y_label=ylab,legend=None)

#d_proj_loc, d_proj_ll_68, d_proj_ul_68, d_proj_ll_95, d_proj_ul_95 = histplot1d(d_proj,'dproj',prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=None,y_lim=None,x_label='dproj',y_label=ylab,legend=None)
...
#histplot1d(v_3d_obs,'v3dobs',prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=None,y_lim=(0,500),x_label='v_3D_obs',y_label=ylab,legend=None)

#histplot1d(v_3d_col,'v3dcol',prob=probinput,N_bins=N_bins_1d,histrange=None,x_lim=None,y_lim=(0,1800),x_label='v_3D_col',y_label=ylab,legend=None)
